...
/**
*/
export const ExecutionMode = Object.freeze({ Par:0,"0":"Par",ParReduce:1,"1":"ParReduce",Seq:2,"2":"Seq", });
/**
*/
export class NBody {
    ...
    free() {
        ...
        wasm.__wbg_nbody_free(ptr);
    }
    /**
    * @param {number} num_bodies
    * @param {number} _mode
    */
    constructor(num_bodies, _mode) {
        const ret = wasm.nbody_new(num_bodies, _mode);
        return NBody.__wrap(ret);
    }
    /**
    * @returns {any}
    */
    init_conditions() {
        const ret = wasm.nbody_init_conditions(this.ptr);
    ...
    */
    next_positions() {
        const ret = wasm.nbody_next_positions(this.ptr);
        return takeObject(ret);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('rayon_nbody_demo-single_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
